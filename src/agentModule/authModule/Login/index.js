...
import captionImage from "../../../assets/images/agent-login-caption-image.png";
const initialValue = {
  EmailAddress: "",
  Password: "",
};
      ...
      <Route
        ...
        element={
          <div className="grid m-0 agent__container__login">
            <CustomToast ref={toastRef} message="Login Successfully" />
            <div className="col-12 md:col-8 left__side__login">
              <div className="top__container">
                <SvgWhiteLogo color={"#fff"} />
                <div className="logo__caption">Broker suite</div>
              </div>
              <div className="middle__container">
                <div className="center__image__controller">
                  <img src={captionImage} alt="logo-caption" />
                </div>
            ...
            <div className="col-12 md:col-4 login__side__screen p-5">
              ...
              <div className="col-12 md:col-12 lg:col-12  ">
                <div className="forget__text cursor-pointer">
                  Forgot password?
                </div>
              </div>
            </div>
