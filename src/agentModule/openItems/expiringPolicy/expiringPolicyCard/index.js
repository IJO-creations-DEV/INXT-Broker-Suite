...
const ExpiringPolicyCard = () => {
  ...
  const renderPolicyNumber = (rowData) => {
    return (
      <div className="policy__number__container">
        ...
        <div>
          <div className="policy__number__text">{rowData.PolicyNumber.toUpperCase()}</div>
        </div>
      </div>
    );
  };
  ...
  const renderIssuedDate = (rowData) => {
    return (
      <div className="expiry__data__container">
        <div className="expiry__data__text">{rowData.policyIssued.toUpperCase()}</div>
      </div>
    );
  };
  ...
  const renderExpiryDate = (rowData) => {
    return (
      <div className="expiry__data__container">
        <div className="expiry__data__text">{rowData.ExpiryDate.toUpperCase()}</div>
      </div>
    );
  };
