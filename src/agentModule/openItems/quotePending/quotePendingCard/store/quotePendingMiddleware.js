...
import {GET_QUOTEPENDINGTABLE_DATA, GET_QUOTEPENDING_SEARCH } from "../../../../../redux/actionTypes";
...
export const getQuotependingSearchDataMiddleWare = createAsyncThunk(
  ...
  async ({ field, value}, { rejectWithValue, getState }) => {
    ...
    try {
      const filteredPayments = filterPaymentsByField(quotependingtabledata, field, value);
