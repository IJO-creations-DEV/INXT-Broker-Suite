        ...
        <div>
            ...
            <div  className="lead__table__container">
                ...
                >
                    ...
                    <Column body={renderGrossPremium} header={renderUncheckedHeader("GrossPremium")} headerStyle={headerStyle}></Column>
                    <Column body={renderExpiryDate} header={renderUncheckedHeader("ExpiryDate")} headerStyle={headerStyle}></Column>
                    <Column body={renderPayment} header={renderUncheckedHeader("Payment")} headerStyle={headerStyle}></Column>
