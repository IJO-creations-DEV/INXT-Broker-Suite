...
const PolicyApprovalCard = () => {
    ...
    return (
        <div className='policy__approval__card__container mt-4'>
            <Card className='pt-5'>
                <div className='policy__approval__card__title'>
                    Waiting for Policy
                </div>
                <div className='policy__approval__card__image__containe mt-4'>
                    <Image src='https://i.ibb.co/gz54P23/Hourglass.png' width='106px' height='187px' />
                </div>
                <div className='policy__approval__card__sub__text__container mt-3'>
                <div className='policy__approval__card__sub__text'>
                    The quotation has been submitted to the Insurance Company.
                    Kindly wait for the issuance of the Insurance Policy
                </div>
                </div>
            ...
            <div className="recived__btn__container">
              <Button className="recived__btn" onClick={()=>{handleclick()}}>Policy Received</Button>
            </div>
            </div>
            </Card>
        </div>
