  ...
  return (
    <div className='upload__policy__container'>
      ...
      <div className="grid mt-3">
        <div className="upload__policy__container__back__btn__container col-12 md:col-6 lg:col-6">
        <SvgLeftArrow />
        <div className='upload__policy__container__back__btn__title'>Lead ID: 12345678</div>
      </div>
      <div className="upload__policy__container__quote__container col-12 md:col-6 lg:col-6">
