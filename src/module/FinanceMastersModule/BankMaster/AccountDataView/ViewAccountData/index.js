...
function ViewAccountDetail() {
  ...
  const { accountDetailsView, loading } = useSelector(({ bankMasterReducer }) => {
    return {
  ...
  const Type = [
    { name: accountDetailsView.AccountType, code: accountDetailsView.AccountType },
...
/> */}
        ...
        <div className='tablegap_container' >
          ...
          >
            ...
            <Column field="VoucheDate" header="Stats" headerStyle={headerStyle} className='fieldvalue_container'></Column>
            <Column
              body={(columnData) => (
                <SvgEdit />
              )}
