...
import "../SaveAndEditExchange/index.scss"
...
const SaveAndEditExchange = () => {
    const [visiblePopup, setVisiblePopup] = useState(false);
    const [date, setDate] = useState(new Date());
    const items = [
        { label: 'Exchange Rate', url: '/exchangerate' },
        { label: 'Exchange rate Details', url: '/saveandaddexchange' },
    ...
    return (
        <div className='grid sub__add__container'>
            ...
            <div className='col-12 mb-3 header__button__view'>
                <div>
                <div className='add__sub__title'>Exchange Rate Details</div>
                <div className='mt-3'>
...
export default SaveAndEditExchange