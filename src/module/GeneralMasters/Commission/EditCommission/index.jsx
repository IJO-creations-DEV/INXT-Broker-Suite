...
//                 <div className='add__sub__title'><div onClick={handleGoBack} className='mr-2 mt-1'><ArrowLeftIcon /></div>Edit Commissions</div>
//                 <div className='mt-3'>
...
const EditCommission = () => {
    ...
    const setFormikValues = () => {
        ...
        if(selectCoversData){
            formik.setValues({ ...formik.values, ...updatedValues });
            setSelectedCoverOption([{label:selectCoversData,value:selectCoversData}])
        }
        if(selectAgentData){
            formik.setValues({ ...formik.values, ...updatedValues });
            setSelectAgentDataOption([{label:selectAgentData,value:selectAgentData}])
        }
        formik.setValues({ ...formik.values, ...updatedValues });
    };
    const formik = useFormik({
