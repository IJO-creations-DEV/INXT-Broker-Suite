...
import { patchEmployeeEditMiddleware, postAddEmployeeMiddleware } from "../store/employeeMiddleware";
...
const AddEmployee = ({ action }) => {
  ...
  const item5 = [
    {
      label: action === "add" ? "Driving License" : employeeEditData?.idProofType,
      label: action === "add" ? "Driving License" : employeeEditData?.idProofType
    },
    {
