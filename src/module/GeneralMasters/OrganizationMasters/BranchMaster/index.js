...
const Index = () => {
  ...
  const handlePolicy =(id)=>{
    navigate(`/master/generals/organization/branchmaster/addbranchmaster/add/:${id}`)
  }
  const handleView = (id) => {
    navigate(`/master/generals/organization/branchmaster/addbranchmaster/view/:${id}`)
  }
  const handleEdit = (id) => {
    navigate(`/master/generals/organization/branchmaster/addbranchmaster/edit/:${id}`)
  }
      ...
      >
        ...
        <div className="header_search_container">
          <div class="col-12 md:col-6 lg:col-10" style={{ paddingLeft: 0 }}>
            ...
            <span className="p-input-icon-left" style={{ width: "100%" }}>
              ...
              <InputText placeholder="Search By company code/ Name" className="searchinput_left" />
            </span>
          </div>
          {/* </div> */}
        ...
        <div >
          ...
          >
            ...
            <Column field="VoucherNumber" header="Branch Code"  headerStyle={headerStyle} className='fieldvalue_container'></Column>
            <Column field="TransactionNumber" header="Company Name"  headerStyle={headerStyle} className='fieldvalue_container'></Column>
            <Column field="CustomerCode" header="Country"  sortable headerStyle={headerStyle} className='fieldvalue_container'></Column>
            {/* <Column field="VoucheDate" header="Email"  headerStyle={headerStyle} className='fieldvalue_container'></Column> */}
            <Column field="Amount" header="Email" headerStyle={headerStyle} className='fieldvalue_container'></Column>
