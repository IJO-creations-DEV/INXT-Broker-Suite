...
import { getpaymentVocherByIdMiddleware, paymentVocherMiddleware } from "./paymentVocherMiddleware";
...
const paymentVoucherReducer = createSlice({
    ...
    extraReducers: (builder) => {
        ...
        builder.addCase(getpaymentVocherByIdMiddleware.fulfilled, (state, action) => {
            state.loading = false;
            state.individualVoucher = action.payload;
        });
        builder.addCase(getpaymentVocherByIdMiddleware.rejected, (state, action) => {
            state.loading = false;
