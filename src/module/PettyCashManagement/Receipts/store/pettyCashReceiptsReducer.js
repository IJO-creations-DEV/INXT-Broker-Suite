...
import { getPettyCashReceiptsListMiddleware, getPettyCashReceiptsByIdMiddleware } from "./pettyCashInitiateMiddleware";
...
const PettyCashReceiptsReducer = createSlice({
    ...
    extraReducers: (builder) => {
        builder.addCase(getPettyCashReceiptsListMiddleware.pending, (state) => {
            state.loading = true;
        });
        builder.addCase(getPettyCashReceiptsListMiddleware.fulfilled, (state, action) => {
            state.loading = false;
            state.paymentVocherList = action.payload;
        });
        builder.addCase(getPettyCashReceiptsListMiddleware.rejected, (state, action) => {
            state.loading = false;

            state.paymentVocherList = {};
            state.error = typeof action.payload === "string" ? action.payload : "";
        });
        builder.addCase(getPettyCashReceiptsByIdMiddleware.pending, (state) => {
            state.loading = true;
        });
        builder.addCase(getPettyCashReceiptsByIdMiddleware.fulfilled, (state, action) => {
            state.loading = false;
            state.individualVoucher = action.payload;
        });
        builder.addCase(getPettyCashReceiptsByIdMiddleware.rejected, (state, action) => {
            state.loading = false;
