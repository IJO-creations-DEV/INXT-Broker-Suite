...
import { getPettyCashReplenishListMiddleware, getPettyCashReplenishByIdMiddleware } from "./pettyCashReplenishMiddleware";
...
const PettyCashReplenishReducer = createSlice({
    ...
    extraReducers: (builder) => {
        builder.addCase(getPettyCashReplenishListMiddleware.pending, (state) => {
            state.loading = true;
        });
        builder.addCase(getPettyCashReplenishListMiddleware.fulfilled, (state, action) => {
            state.loading = false;
            state.paymentVocherList = action.payload;
        });
        builder.addCase(getPettyCashReplenishListMiddleware.rejected, (state, action) => {
            state.loading = false;

            state.paymentVocherList = {};
            state.error = typeof action.payload === "string" ? action.payload : "";
        });
        builder.addCase(getPettyCashReplenishByIdMiddleware.pending, (state) => {
            state.loading = true;
        });
        builder.addCase(getPettyCashReplenishByIdMiddleware.fulfilled, (state, action) => {
            state.loading = false;
            state.individualVoucher = action.payload;
        });
        builder.addCase(getPettyCashReplenishByIdMiddleware.rejected, (state, action) => {
            state.loading = false;
